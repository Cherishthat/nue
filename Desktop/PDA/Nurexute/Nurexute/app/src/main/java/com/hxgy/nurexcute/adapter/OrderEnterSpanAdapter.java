...
public class OrderEnterSpanAdapter extends BaseAdapter {

	Context context;
	List<OrdEnterBaseItemDTO> list;
	public OrderEnterSpanAdapter(Context contex,List<OrdEnterBaseItemDTO> list){
		this.context=contex;
		this.list=list;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		OrdEnterBaseItemDTO dto = list.get(position);
