...
public class OrderDoseqtySpanAdapter extends BaseAdapter {

	Context context;
	List<ArcItemDoseQtyDTO> list;
	public OrderDoseqtySpanAdapter(Context contex,List<ArcItemDoseQtyDTO> list){
		this.context=contex;
		this.list=list;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ArcItemDoseQtyDTO dto = list.get(position);
