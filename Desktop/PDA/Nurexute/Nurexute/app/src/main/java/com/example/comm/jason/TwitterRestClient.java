...
//	private static final String BASE_URL = "http://172.22.134.19/trakcarelive/trak/web/web.JSONBroker.cls";
	...
	//达州医院IPsp1
//	private static final String BASE_URL = "http://172.77.67.5/trakcarelive/trak/web/web.JSONBroker.cls";
//	private static final String BASE_URL = "http://172.22.6.10/trakcarelive/trak/web/web.JSONBroker.cls";
//	private static final String BASE_URL = "http://172.77.67.1/trakcarelive/trak/web/web.JSONBroker.cls";
	//private static final String BASE_URL = "http://172.80.19.1/trakcarelive/trak/web/web.JSONBroker.cls";
	  // private static final String BASE_URL = "http://172.22.6.10/trakcarelive/trak/web/web.JSONBroker.cls";
